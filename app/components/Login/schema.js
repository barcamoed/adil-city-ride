...
export const bookingSchema = Yup.object().shape({
  ...
  email: Yup.string()
    .email()
    .required('Required'),
  arrival_date: Yup.date().when('type', {
    is: val => val === 'justArrival' || val === 'both',
    then: Yup.date().required('Required'),
    otherwise: Yup.date(),
  }),

  arrival_flight_number: Yup.string().when('type', {
    is: val => val === 'justArrival' || val === 'both',
  ...
  // departure_date: Yup.date().required('Required'),
  departure_flight_number: Yup.string().when('type', {
    is: val => val === 'justDeparture' || val === 'both',
    then: Yup.string().required('Required'),
    otherwise: Yup.string(),
  }),
